...
namespace ReferenceBook.Domain.AggregatesModel.CountryAggregate
{
    ...
    public class Country : Entity<short>
    {
        ...
        public Country(string name, Alpha2Code alpha2Code, Alpha3Code alpha3Code, short numericCode, Region region, SubRegion subRegion)
        {
            Name = name;
        ...
        public SubRegion SubRegion { get; private set; }
    }
}