...
using TaxLegal.Cbc.Report.Application.Schemas.V101.Models.Xml;
using TaxLegal.Cbc.Report.Application.Services.Implementations;
using TaxLegal.Cbc.Report.Application.Services.Interfaces;

namespace TaxLegal.Cbc.Report.Application.Schemas.V101.Services
{
    public class SchemaService : ISchemaService
    {
        ...
        {
            return this.Validate(file, Path.Combine("Xsd", "1.0.1"));
        }
    }
}