...
import {ReportData, ReportDataGenerateRequest, ReportDataParseRequest, ReportDataValidationRequest, ValidationMessage} from "../models";
...
class CbcService extends ApiCrudService<number, any, any> {
	...
	public generate(request: ReportDataGenerateRequest): Promise<AxiosResponse> {
		return this.instance.post(`reports/generate`, request.data, {responseType: 'blob'});
	}
